  ...
  const highlights = [
    {
      ...
      title: "Full Stack",
      description:
        "Java, Spring Boot, React, Angular, Node.js - développement d'applications web complètes.",
    },
    {
      icon: Cloud,
      title: "Cloud & DevOps",
      description:
        "AWS, GCP, Azure, Docker, Kubernetes - infrastructure cloud moderne et automatisée.",
    },
    {
      icon: GraduationCap,
      title: "Master IA",
      description: "Master 2 Intelligence Artificielle à l'EPSI Lille.",
    },
    {
      icon: Rocket,
      title: "CI/CD",
      description:
        "Jenkins, Git Flow, tests automatisés - livraison continue et qualité de code.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                , développeur Full Stack et DevOps avec 2 ans d'expérience
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Mon expertise couvre le développement d'applications bancaires
                en Java/Spring Boot, l'intégration de données avec SSIS et
                DataStage, ainsi que la mise en place de pipelines CI/CD avec
                Jenkins.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Titulaire d'un{" "}
                ...
                à l'EPSI Lille, je combine mes compétences en développement avec
                les technologies d'IA comme TensorFlow et PySpark.
              </p>

              {/* Languages */}
              <div className="pt-6 border-t border-border">
                <h3 className="font-semibold font-display mb-4 text-foreground">
                  Langues
                </h3>
