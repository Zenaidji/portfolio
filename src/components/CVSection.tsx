...
const CVSection = () => {
  ...
  const education = [
    ...
    {
      title: "BAC Technique Mathématiques",
      ...
      <div className="container px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            <span className="text-primary font-medium tracking-wider uppercase text-sm">Parcours</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-bold font-display text-foreground">Expériences</h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-bold font-display text-foreground">Formation</h3>
              </div>
              ...
              {/* Interests */}
              <div className="mt-12">
                <h3 className="text-xl font-bold font-display mb-6 text-foreground">Centres d'intérêt</h3>
                <div className="flex flex-wrap gap-3">
                  {["Nature & Randonnée", "Football", "Natation", "Cinéma", "Mangas & Animés"].map((interest, index) => (
                    <span 
                      key={index}
