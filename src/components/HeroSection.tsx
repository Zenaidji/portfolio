          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto lg:mx-0 mb-8 animate-slide-up animation-delay-400">
                Développeur Full Stack et DevOps avec 2 ans d'expérience en
                développement Java à la Banque Populaire. Expertise en cloud
                computing (AWS, GCP, Azure) et actuellement en Master 2
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4 animate-slide-up animation-delay-600">
                <a
                  href="https://github.com/Zenaidji"
                  target="_blank"
